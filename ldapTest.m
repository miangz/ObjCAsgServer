...
-(char *)retrieveEntryOld:(char *)uid{
    char dn[100];
    strcpy(dn,"cn=");
    strcat(dn, uid);
    strcat(dn, ",dc=localhost,dc=com");
...
-(char *)getStockList:(char *)uid{
    ...
    if ( e != NULL ) {
        ...
        /* Iterate through each attribute in the entry. */
        char *stockName = (char*)malloc(100*sizeof(char));
        for ( a = ldap_first_attribute( ld, e, &ber );
...
//                        return vals[i];
                        if (strlen(stockName) < 1) {
                            ...
                            NSString *t = @"\t";
                            strcat(stockName,[t UTF8String]);
                            strcat(stockName,vals[i]);
                        }
                    }
                }
...
-(int)addASyncWithCN:(char*)cname SN:(char*)sname uid:(char*)uid andPass:(char*)pass{
    ...
    char *object_vals[] = { "top", "person", "organizationalPerson", "inetOrgPerson", "miangPerson", NULL };
...
-(int)addASyncWithCNOld:(char*)cname SN:(char*)sname uid:(char*)uid andPass:(char*)pass{
...
-(int) modifyOld:(char *)stock withUID:(char *)uid{
